...
WS.comment('#38 Verify Verify if Response Code is TV')

WS.verifyMatch(response_code, 'TV', false)
...
WS.comment('#56 Verify if Trx Object value is BRIMON - TV')

WS.verifyMatch(trx_object, 'BRIMON - TV', false)
