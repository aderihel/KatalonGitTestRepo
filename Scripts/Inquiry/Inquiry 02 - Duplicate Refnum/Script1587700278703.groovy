...
GlobalVariable.reqRefnum = '123456789613'
...
WS.comment('#38 Verify Verify if Response Code is 02')

WS.verifyMatch(response_code, '02', false)
...
WS.comment('#54 Verify if Trx Status value is Gagal')

WS.verifyMatch(trx_status, 'Gagal', false)

WS.comment('#56 Verify if Trx Object value is BRIMON - 02')

WS.verifyMatch(trx_object, 'BRIMON - 02', false)
